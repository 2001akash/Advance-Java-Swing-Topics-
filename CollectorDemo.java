...
//Map <Boolean, List<Mobile>> mp = al.stream().sorted((m1, m2) -> m2.ram.compareTo(m1.ram) )
//.collect(Collectors.partitioningBy(a -> a.OS.equals("Android")));

Map <Integer, List<Mobile>> mp = al.stream().sorted((m1, m2) -> m2.ram.compareTo(m1.ram) ) .collect(Collectors.groupingBy(x -> x.ram));
